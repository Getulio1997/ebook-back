...
public class LivrosService {
    ...
    public ResponseEntity<Livros> listarLivrosPorId(Integer id) { // Chamando o atributo listarLivrosPorId da
                                                                  // controller.
        Livros livros = livrosRepository.findById(id).orElse(null); // Validando para listar usuários por ID na
                                                                    // controller.
