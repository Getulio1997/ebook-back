...
public class LivrosController {
    ...
    // Fazendo uma listagem do modelo livros trazendo todos os livros registrados no banco de dados.
    ...
    @GetMapping("/{id}") // Metodo GET para listar os livros por ID.
     // Fazendo uma listagem do modelo usuário trazendo por ID os livros registrados no banco de dados.
    ...
    public Livros novoLivros(@RequestBody Livros livros) { // Criação de um novo livros.
        Livros novoLivros = livrosService.novoLivros(livros); // Fazendo as validações na service
        return novoLivros;
    }
